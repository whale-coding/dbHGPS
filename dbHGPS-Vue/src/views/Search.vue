          ...
          >
            <el-form-item label="Chromosome">
              <el-input
                ...
                placeholder="Please enter chromosome. eg:chr1"
                style="width: 700px"
              ></el-input>
            </el-form-item>
...
export default {
  ...
  methods: {
    ...
    onBaseSearch() {
      ...
      this.$axios
        .post(" http://localhost:8022/hgps/baseSearch", this.baseSearchForm)
        .then((response) => {
    ...
    onAdvancedSearch() {
      ...
      this.$axios
        .post("http://localhost:8022/hgps/advancedSearch", this.advancedSearchForm)
        .then((response) => {
